...
class SubjectResult(models.Model):
    ...
    semester = models.fields.PositiveSmallIntegerField(null=True)

    def __str__(self):
        return "%s - %s - %s" % (self.subject, "Total Marks", self.total_marks)
...
class SemesterResult(models.Model):
    ...
    def __str__(self):
        return "%s - %s - %s" % (self.student_id, "Grand total" , self.grand_total)
